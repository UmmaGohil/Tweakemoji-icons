...
const Happy = props => (
    <svg 
        ...
        <circle cx="29" cy="22" r="5" fill="#FF7892"></circle>
        <circle cx="7" cy="22" r="5" fill="#FF7892"></circle>
        <path
            fill="#664500"
